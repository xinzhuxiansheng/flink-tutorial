...
import com.yzhou.common.utils.SqlUtil;
import com.yzhou.job.constant.FlinkSQLConstant;
...
public class SqlRunner02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] statements = SqlUtil.getStatements(script, FlinkSQLConstant.SEPARATOR); //

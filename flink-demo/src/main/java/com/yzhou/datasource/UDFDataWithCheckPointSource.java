 ...
 * @date 2021/11/17
 */
public class UDFDataWithCheckPointSource {
    private static Logger logger = LoggerFactory.getLogger(UDFDataWithCheckPointSource.class);

    public static void main(String[] args) throws Exception {

        logger.info("========================running job witch checkpoint===========================");
